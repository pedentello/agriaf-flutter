...
public class UrlLauncherPlugin implements MethodCallHandler {
  ...
  public static class WebViewActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      String userAgent = webview.getSettings().getUserAgentString(); // add this line
      userAgent = userAgent.replaceAll("Version[^\\s]+",""); // add this line
      webview.getSettings().setUserAgentString(userAgent);  // add this line
